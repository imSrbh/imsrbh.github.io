...
layout: page
title: Projects
subtitle: A collection of my AI/ML and GenAI projects
comments: true
carbonads: true
---
This is a collection of some personal and professional projects I've worked on. More projects available on my [GitHub](https://github.com/imSrbh).
...
Code: [RecsysAssociationPy](https://github.com/imSrbh/RecsysAssociationPy)  
...
Code: [xml2Kitti](https://github.com/imSrbh/xml2Kitti)  
...
• Set up JupyterHub on a local server using Docker and docker-compose with multi-user basic authentication. Detailed guide: [Blog](https://imsaurabh.me/SettingUPtljh/)  
